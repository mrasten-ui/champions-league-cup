...
// Visual bracket order derived from KNOCKOUT_PROGRESSION so that adjacent
// pairs in each round feed into the same match in the next round.
// This ensures connector lines in KnockoutTreeView draw correctly.
export const BRACKET_VISUAL_ORDER: Record<string, string[]> = {
