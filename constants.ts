...
const EN_TRANSLATION: Translation = {
    ...
    rule6Title: "6. Miss a Deadline? The Computer's Got You", rule6Desc: "Every account has a Risk Profile, tunable any time from the gauge on the Predictor tab — 10 manager-styled presets running from ultra-cautious to total chaos. If a deadline passes before you get your pick in, we auto-fill it for you from that profile — you'll never score a blank. Auto-filled picks are marked with a 🤖.",
...
const SCO_TRANSLATION: Translation = {
    ...
    rule6Title: "6. Missed the Cutoff? The Computer's Got Ye", rule6Desc: "Every profile's goat a Risk Level, tweakable onytime fae the gauge oan the Predictor tab — 10 manager-styled presets fae ultra-cannie tae total mayhem. Miss a deadline and we'll fill it in fur ye based oan that — ye'll never score a big fat zero. Auto-filled picks get a wee 🤖 tag.",
