...
const EN_TRANSLATION: Translation = {
    ...
    deadlineTitle: "🚨 The Deadline", deadlineBodyPre: "Your entire board — both Group Stage scores and Knockout Stage picks — must be submitted before the tournament begins. All predictions lock permanently at", deadlineBodyPost: ", exactly 15 minutes before the opening kick-off.",
...
const SCO_TRANSLATION: Translation = {
    ...
    deadlineTitle: "🚨 The Cutoff", deadlineBodyPre: "Yer entire board — groups and knockoots baith — must be in before the tournament kicks aff. Everything locks deid at", deadlineBodyPost: ", a full 15 minutes before the openin' whistle.",
    ...
    scoreExact: "Bang On (e.g. 2-1)", scoreResult: "Right Winner", scorePenalty: "Idiot Tax", scoreKnockoutTitle: "Big Points", scoreKnockoutDesc: "Halves aw yer knockout points from R16 tae the Final. Round of 32 is unaffected.",
...
const US_TRANSLATION: Translation = {
    ...
    deadlineTitle: "🚨 The Deadline", deadlineBodyPre: "Your entire board — Group Stage scores and Bracket picks — must be locked in before the tournament starts. Everything freezes at", deadlineBodyPost: ", exactly 15 minutes before opening kick-off.",
    ...
    scoreExact: "Perfect Pick (e.g. 2-1)", scoreResult: "Correct Winner", scorePenalty: "Reset Penalty", scoreKnockoutTitle: "Playoff Points", scoreKnockoutDesc: "Halves all playoff points from Round of 16 to the Final. Round of 32 is unaffected.",
...
const NO_TRANSLATION: Translation = {
    ...
    deadlineTitle: "🚨 Fristen", deadlineBodyPre: "Hele brettet ditt — både gruppespillresultater og sluttspillvalg — må leveres før turneringen begynner. Alle tips låses permanent kl.", deadlineBodyPost: ", nøyaktig 15 minutter før åpningskampen.",
    ...
    scoreExact: "Eksakt Resultat (f.eks 2-1)", scoreResult: "Riktig Utfall (Seier/Uavgjort)", scorePenalty: "Straff for Ny Sjanse", scoreKnockoutTitle: "Sluttspillpoeng", scoreKnockoutDesc: "Halverer alle sluttspillpoeng fra runde 16 til finalen. R32 er ikke berørt.",
