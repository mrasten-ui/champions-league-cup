...
export interface Database {
  public: {
    Tables: {
      ...
      matches: {
        Row: { id: string; date: string | null; venue: string | null; group_id: string | null; round: string | null; matchday: number | null; home_team_id: string | null; away_team_id: string | null; home_score: number | null; away_score: number | null; status: string | null; is_locked: boolean | null; api_id: string | null; next_match_id: string | null; channels: Json | null; minute: number | null; penalty_winner_id: string | null; };
