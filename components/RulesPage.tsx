...
const ScoringSection: React.FC<{ lang: Translation }> = ({ lang }) => (
  <div id="rules-scoring-section" className="space-y-3">
    ...
    <div className="bg-violet-50 border border-violet-100 rounded-2xl p-4 flex flex-col items-center gap-0.5">
      <span className="text-5xl font-black text-violet-600 leading-none">3</span>
      ...
      <span className="text-[10px] font-black text-violet-900 uppercase tracking-tight text-center mt-2 leading-tight">{lang.scoreQualTitle}</span>
      <p className="text-[9px] text-violet-700/70 font-medium leading-relaxed text-center mt-0.5">{lang.scoreQualDesc}</p>
    </div>
