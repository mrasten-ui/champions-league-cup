...
export const KnockoutTreeView: React.FC<KnockoutTreeViewProps> = ({
  ...
  // R32 pairs: R32_3+R32_6→R16_3, R32_1+R32_4→R16_1, R32_13+R32_15→R16_6, R32_7+R32_12→R16_5,
  //            R32_2+R32_5→R16_2, R32_10+R32_11→R16_4, R32_9+R32_8→R16_7, R32_16+R32_14→R16_8
  // R16 pairs: R16_3+R16_1→QF_1, R16_6+R16_5→QF_3, R16_2+R16_4→QF_2, R16_7+R16_8→QF_4
  // QF pairs:  QF_1+QF_3→SF_1, QF_2+QF_4→SF_2  (DB: SF_1=FRA/ESP, SF_2=ENG/ARG)
  const VISUAL_ORDER: Record<string, string[]> = {
    R32: ['R32_3','R32_6','R32_1','R32_4','R32_13','R32_15','R32_7','R32_12',
          'R32_2','R32_5','R32_10','R32_11','R32_9','R32_8','R32_16','R32_14'],
    R16: ['R16_3','R16_1','R16_6','R16_5','R16_2','R16_4','R16_7','R16_8'],
    QF:  ['QF_1','QF_3','QF_2','QF_4'],
    SF:  ['SF_1','SF_2'],
    FIN: ['FIN_1'],
    '3RD': ['3RD_1'],
  };
