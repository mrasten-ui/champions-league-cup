...
export const GroupStageSummary: React.FC<GroupStageSummaryProps> = ({ matches, teams, lang, phase, hasTakenSecondChance, onSecondChance, userPredictions, onGoToGroup, onGoToKnockout, onTeamClick }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      ...
      {/* Second Chance Banner (Only visible in LIVE phase and if not taken yet) */}
      ...
      {/* SECTION 1: Third Place Rankings (Critical Info) */}
      <section>
      ...
      <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-6">
             {Object.entries(allStandings).map(([groupId, standings]) => {
                 ...
                 let dotColor = 'bg-slate-600'; // Default gray
