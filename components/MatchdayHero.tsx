            ...
            <div className="flex-1 flex flex-col items-center gap-3 group/team cursor-pointer" onClick={() => !isHomeTBD && onTeamClick(home.id)}>
                {isHomeTBD ? (
                    ...
                    <div className="flex items-center gap-1.5 transform transition-transform group-hover/team:scale-110 duration-300">
                        {heroHomeKitBg && <JerseyIcon bg={heroHomeKitBg} text={lineups.find(l => l.teamId === match.homeTeamId)?.kitText ?? '#fff'} size={38} />}
            ...
            <div className="flex-1 flex flex-col items-center gap-3 group/team cursor-pointer" onClick={() => !isAwayTBD && onTeamClick(away.id)}>
                {isAwayTBD ? (
                    ...
                    <div className="flex items-center gap-1.5 transform transition-transform group-hover/team:scale-110 duration-300">
                        ...
                        {heroAwayKitBg && <JerseyIcon bg={heroAwayKitBg} text={lineups.find(l => l.teamId === match.awayTeamId)?.kitText ?? '#fff'} size={38} />}
                    </div>
                )}
                {!isAwayTBD && (
                    <div className="flex flex-col items-center">
