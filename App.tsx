                    ...
                    {GROUP_CONFIG.map(g => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`absolute bottom-1 right-1 w-2.5 h-2.5 rounded-full border border-black/50 ${isComplete ? 'bg-green-50/20 bg-green-500 shadow-[0_0_5px_rgba(34,197,94,0.8)]' : inProgress ? 'bg-yellow-400 shadow-[0_0_5px_rgba(250,204,21,0.8)]' : 'bg-slate-500'}`}></div>
                            </button>
                        );
                    })}
